...
class AntEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    ...
    def get_forward_reward(self, x_velocity, y_velocity):
        return self.velocity_weight['x']*x_velocity + self.velocity_weight['y']*y_velocity
    ######################################
    ...
    def append_goal_to_state(self, obs):
        ...
        # print('\t'+'@'*80)
        # print('\tSTEP GOAL {}'.format(np.array([self.velocity_weight['x'], self.velocity_weight['y']])))
        # print('\t'+'@'*80)
    ...
    def reset_goal(self):
        ...
        # print('$'*80)
        # print('RESET GOAL {}'.format(np.array([self.velocity_weight['x'], self.velocity_weight['y']])))
        # print('$'*80)

    def reset(self):
        obs = mujoco_env.MujocoEnv.reset(self)
        # print('obs from reset env')
        self.reset_goal()
        x = self.append_goal_to_state(obs)
        # print('x from reset env')
        # print(x)
        return x
